                ...
                <div id="creditcard_div" hidden>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    {!! Form::select('credit_card_type', array_add($card_type, '','Select Payment Method'), old('credit_card_type'), ['id'=>'credit_card_type','class' => 'form-control select2 validate[required]']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    {!! Form::text('credit_card_number', old('credit_card_number'), ['id'=>'credit_card_number','class' => 'form-control validate[required, condRequired[creditCard]]', 'placeholder'=>'Credit Card Number']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    {!! Form::text('cvv', old('cvv'), ['id'=>'cvv','class' => 'form-control validate[required, custom[number],condRequired[maxSize[3]]]', 'placeholder'=>'CVV']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    {!! Form::text('first_name', old('first_name'), ['id'=>'first_name','class' => 'form-control validate[required]', 'placeholder'=>'First Name']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    {!! Form::text('last_name', old('last_name'), ['id'=>'last_name','class' => 'form-control validate[required]', 'placeholder'=>'Last Name']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
