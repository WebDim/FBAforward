        ...
        <div class="table-responsive no-padding">
            <table class="table" id="list">
                ...
                <tr>
                    ...
                    <td id="shipment{{$shipments->shipment_id}}" colspan="2"><a onclick="verifyshipment('{{$shipments->shipment_id}}','3')">@if($shipments->shipping_label==2)Verify Shipment Load On Truck</a>@endif</td>
                </tr>
                </tbody>
            </table>
        </div>
