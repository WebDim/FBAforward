                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        {!! Form::label('mws_authtoken', 'MWS Authtoken *') !!}
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"></span>
                                {!! Form::text('mws_authtoken', old('mws_authtoken', !empty($customer_amazon_detail[0]->mws_authtoken) ? decrypt($customer_amazon_detail[0]->mws_authtoken): null), ['class' => 'form-control validate[required]', 'placeholder'=>'MWS Authtoken']) !!}
                            </div>
