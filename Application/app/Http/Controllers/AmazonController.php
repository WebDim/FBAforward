...
class AmazonController extends Controller
{
    ...
    public function addamazoncredential(AmazoncredentialRequest $request)
    {
        ...
        if ($validamazonMWS == 1) {
            ...
            return redirect('member/amazoninventorylist')->with('success', 'Your Amazon Credential Updated Successfully, We are fetching your products, Please passionate check it after 5 minutes.');
        } else {
