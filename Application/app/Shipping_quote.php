...
class Shipping_quote extends Model
{
    ...
    protected $fillable = ['order_id','shipment_id','shipment_port', 'shipment_term', 'shipment_weights','chargable_weights','cubic_meters','no_of_pallets','total_shipping_cost','status'];
